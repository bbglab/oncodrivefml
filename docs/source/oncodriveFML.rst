...
We described the method and illustrated its usefulness to identify protein coding genes, promoters, untranslated regions, intronic splice regions, and lncRNAs-containing driver mutations in several malignancies in 
`Mularoni et al., Genome Biology 2016 <http://genomebiology.biomedcentral.com/articles/10.1186/s13059-016-0994-0>`_.

To use OncodriveFML check its `website <http://bg.upf.edu/oncodrivefml>`_ or download the source code
